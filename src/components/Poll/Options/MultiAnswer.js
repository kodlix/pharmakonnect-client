...
const MultiAnswerOption = ({questionType, getSelectedOption, resetOptions, initialCount }) => {
            ...
            <div key={i + '@' +  elementId} className="input-group col-12 col-md-10 mb-2" id={'option-div-' + (i + '@' +  elementId)}>
                <div className="input-group-prepend">
                    <div className="input-group-text">
                        <input type="checkbox" name={'option-checkbox-' + elementId} id={'option-checkbox-' + (i + '@' +  elementId)}
